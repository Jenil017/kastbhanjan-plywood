...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1488189003ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="192">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=playwood_db&table=clients">`playwood_db`.`clients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wp5&table=wp5_users">`wp5`.`wp5_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db1&table=todos">`db1`.`todos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db1&table=flights">`db1`.`flights`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dvwa1&table=guestbook">`dvwa1`.`guestbook`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dvwa1&table=users">`dvwa1`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aoot&table=student">`aoot`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=jdbc_db&table=jdbc_db">`jdbc_db`.`jdbc_db`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=exam1&table=student">`exam1`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=movie&table=movie+name">`movie`.`movie name`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="233431424a4c796038696f704344267e">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="192"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="playwood_db" targettable="">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE IF NOT EXISTS products (
    ...
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE IF NOT EXISTS users (
    id INT(11) AUTO_INCREMENT PRIMARY KEY,
    ...
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
                            ...
                            targetdb="playwood_db" targettable="clients">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE clients ADD COLUMN number VARCHAR(255);</span>
                        </div>
